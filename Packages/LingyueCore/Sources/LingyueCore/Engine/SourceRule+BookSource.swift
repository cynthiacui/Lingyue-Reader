...
///
/// The App Store target relies on this: the imported JSON for a
/// 笔趣阁-shaped or 5dxs-shaped source carries every site-specific
/// detail, so the binary stays free of hard-coded URLs while still
/// being able to drive the source the moment its rule lands in the
/// editable store.
