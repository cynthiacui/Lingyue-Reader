...
Files attached to App Store Connect submissions under the "App Review Information → Attachment" field. These are sample assets for the reviewer, not bundled into the binary.
